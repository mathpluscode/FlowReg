...
from fsdiffreg.model import networks
...
class DDPM(BaseModel):
    ...
    def save_network(self, epoch, iter_step):
        ckpt_dir = Path(self.opt['path']['checkpoint'])
        genG_path = ckpt_dir / f'I{iter_step}_E{epoch}_gen_G.pth'
        opt_path = ckpt_dir / f'I{iter_step}_E{epoch}_opt.pth'
        # gen
        network = self.netG
        if isinstance(self.netG, nn.DataParallel):
